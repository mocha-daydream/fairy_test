...
export const SPIRIT_DATA: Record<SpiritType, SpiritInfo> = {
  [SpiritType.AUTONOMY]: {
    name: "風芽精靈",
    story: "我在輕拂的樹葉聲中醒來，空氣裡的微風正呼喚我的名字。我不是一粒被定型的種子，而是隨風起舞的靈魂。森林很大，但我知道這雙新生的翅膀，只會飛往我心底真正想去的方向。",
    strength: "你擁有一顆不願被定義的心，這份自主是你最強大的羅盤。你擅長在紛擾中傾聽自己的節奏，當你聽從直覺行動時，你的靈魂會綻放出一種無可取代的光采。",
    caution: "當你飛得太遠，孤單的迷霧有時會悄悄襲來。請注意，拒絕被安排不代表自私，而是保留純粹的能量。但別因為害怕「被困住」，而拒絕了那些能為你提供溫暖與安穩的港灣。",
  ...
  [SpiritType.COMPETENCE]: {
    name: "鍛芽精靈",
    story: "我從堅硬岩石的縫隙中探出頭，手心跳動著不熄的火焰。我感覺體內蘊含著改造世界的渴望，每一次揮動翅膀，都是在確認自己的力量。",
    strength: "你追求卓越的意志是森林中最穩定的力量。你擅長透過實踐與學習來獲得掌控感，這份勝任感能讓你即便在暴雨中也能站穩腳跟。",
    caution: "追求完美的火焰有時會變成沉重的枷鎖。迷霧中，別忘了你也是個需要休息的孩子。你的價值不只建立在成就之上，那些努力過的痕跡，本身就是最美的勳章。",
  ...
  [SpiritType.RELATEDNESS]: {
    name: "光芽精靈",
    story: "當第一道暖光包圍我時，我聽見了森林深處溫柔的呼吸。我發現自己並不孤單，周圍每一片葉子的震動都與我息息相關。我伸出手，感受到彼此交會時產生的微熱。",
  ...
  [SpiritType.GROWTH]: {
    name: "森芽精靈",
    story: "我在濕潤土壤的芬芳中緩慢睜開眼，感覺全身的纖維都在悄悄向上延伸。我享受這種持續蛻變的顫動。每一次失敗都像養分，滲進我的根系，讓我走在更好的路上。",
